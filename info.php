...
require_once '<template/cabecera_info.php';
...
if (isset($_GET['id'])) {
    ...
    try {
        ...
        $consulta = "consulta_id_pelis($id).";
        $resultados = consultas($consulta);
        
        // Verificamos si se encontraron resultados
        if (count($resultados) > 0) {
            // Asignamos los resultados a variables para usarlas en el HTML
    ...
    $error = "No se ha proporcionado un ID de película.";
}
?>
	...
	<div class="container">
		<div class="row ipad-width2">
			<div class="col-md-4 col-sm-12 col-xs-12">
                ...
                <?php echo'<img src="./assets/images/pelis/' . $id . '.png" alt="">';?>
					<div class="movie-btn">	
						<div class="btn-transform transform-vertical red">
							<div><a href="#" class="item item-1 redbtn"> </i> Ver Trailer</a></div>
			...
			<div class="col-md-8 col-sm-12 col-xs-12">
				...
				<?php	echo '<h1 class="bd-hd">'. $titulo .'<span>'.  $year .'</span></h1>';?>
					<div class="social-btn">
						<a href="#" class="parent-btn"><i class="ion-heart"></i> Agregar a Favoritos</a>
						<div class="hover-bnt">
							<a href="#" class="parent-btn"><i class="ion-android-share-alt"></i>Compartir</a>
							<div class="hvr-item">
					...
					<div class="movie-rate">
						<div class="rate">
							...
							<p><span>8.1</span> /10<br>
								<span class="rv">56 Vistas</span>
							</p>
						</div>
						<div class="rate-star">
							<p>Calificación de Esta Pelicula:  </p>
					...
					<div class="movie-tabs">
						<div class="tabs">
							<ul class="tab-links tabs-mv">
								<li class="active"><a href="#overview">Descripción</a></li>
								<!-- <li><a href="#reviews"> Comentarios</a></li>
								<li><a href="#cast">  Reparto </a></li>
							    <li><a href="#media"> Media</a></li> -->
								<li><a href="#moviesrelated"> Peliculas Similares</a></li>                        
							</ul>
						        ...
						        <div id="overview" class="tab active">
						            <div class="row">
						            	...
						            	<div class="col-md-4 col-xs-12 col-sm-12">
						            		<div class="sb-it">
						            			<h6>Director: </h6>
						            		<?php	echo '<p><a href="#">'. $director .'</a></p>' ?>
						            		</div>
				
						            		<div class="sb-it">
						            			<h6>Actores: </h6>
						            			<?php	echo '<p><a href="#">'. $actores .'</a></p>' ?>
						            		</div>
						            		<div class="sb-it">
						            			<h6>Generos:</h6>
						            			<?php	echo '<p><a href="#">'. $categoria .'</a></p>' ?>
						            		</div>
						            	<!-- 	<div class="sb-it">
						            			<h6>Release Date:</h6>
